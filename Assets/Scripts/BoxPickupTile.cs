...
{
	[Serializable]
    [CreateAssetMenu(fileName = "New BoxPickupTile", menuName = "Tiles/BoxPickupTile")]
	public class BoxPickupTile : TileBase
	{
...
#if UNITY_EDITOR
	[CustomEditor(typeof(BoxPickupTile))]
	public class AnimatedTileEditor : Editor
	{
		private BoxPickupTile tile { get { return (target as BoxPickupTile); } }
